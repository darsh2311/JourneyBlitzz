...
public class PublishNewVideowithInvalidFormatAVI extends ApplicationUtility {
	...
	public void publishNewVideo() {
		...
		attachmedia("file_example_AVI_480_750kB.avi");
		waitTime(8000);
		...
		try {
			...
			logger.error(
					"Upload Video(submit with Invalid Format AVI button should not be Clickable with Invalid Values: Failed");
		} catch (Exception e) {
			logger.info(
					"Upload Video(submit with Invalid Format AVI button should not be Clickable with Invalid Values: Passed");
		}
