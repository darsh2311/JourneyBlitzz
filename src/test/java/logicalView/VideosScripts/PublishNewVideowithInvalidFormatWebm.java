...
public class PublishNewVideowithInvalidFormatWebm extends ApplicationUtility {
	...
	public void publishNewVideo() {
		...
		try {
			...
			logger.error(
					"Upload Video(submit with Invalid Format WEBM button should not be Clickable with Invalid Values: Failed");
		} catch (Exception e) {
			logger.info(
					"Upload Video(submit with Invalid Format WEBM button should not be Clickable with Invalid Values: Passed");
		}
